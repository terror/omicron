...
// Error type for the blueprint insert transaction that can describe an
// ought-to-be-impossible internal condition where we insert more than we
// expect. (Doing so indicates a bug in our queries, so we don't want to proceed
    ...
    match &update.details {
        PendingMgsUpdateDetails::Sp {
            ...
            if count != 1 {
                ...
                //   inventory collection.  But in that case, how did we manage
                //   to construct a blueprint with it?
                //
